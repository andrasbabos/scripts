...
my $database_size = 50;					#Database Size
my $database_size_str = "gb";   		#String to indicate size: MB / GB or mb / gb
my $database_type = "pgsql";    		#Type = mssql / mysql / pgsql / oracle / MSSQL / MYSQL / ORACLE /PGSQL
